  ...
  <div id="navBar">
    ...
    <div id="navBarMenu">
      ...
      <div class="navBarChoice">
        <div class="opac"></div>
        <p>
          <router-link to="/statistics" class="navBarChoiceLink">Statistics</router-link>
        </p>
      </div>
      <div class="navBarChoice">
        <div class="opac"></div>
        <p>
          <router-link to="/management" class="navBarChoiceLink">Device Management</router-link>
        </p>
      </div>
      <div class="navBarChoice">
        <div class="opac"></div>
        <p>
          <router-link to="/location" class="navBarChoiceLink">Location</router-link>
        </p>
      </div>
