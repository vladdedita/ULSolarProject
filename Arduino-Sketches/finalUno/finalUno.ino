...
void setup() {
  ...
  Serial.println("EEPROM minWestLight:" + String(sensorMinWest));  
  Serial.println("EEPROM maxWestLight:" + String(sensorMaxWest)); 
   Serial.println("EEPROM minEastLight:" + String(sensorMinEast));  
  Serial.println("EEPROM maxEastLight:" + String(sensorMaxEast));  
